...
func setNodeBlob(root common.Hash, hash common.Hash, blob []byte) error {
	...
	if err := nodeBlobDB.Set(nodeBlobKey, blob, pebble.NoSync); err != nil {
		return err
	}
	if err := hashNodeDB.Set(hashNodeKey, root[:], pebble.NoSync); err != nil {
		return err
	}
	return nil
}
